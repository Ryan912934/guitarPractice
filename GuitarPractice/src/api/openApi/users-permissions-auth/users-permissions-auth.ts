...
export const getGetConnectQueryKey = () => [`/connect/(.*)`] as const;
  

    
export const getGetConnectInfiniteQueryOptions = <TData = Awaited<ReturnType<typeof getConnect>>, TError = AxiosError<void | Error>>( options?: { query?:UseInfiniteQueryOptions<Awaited<ReturnType<typeof getConnect>>, TError, TData>, axios?: AxiosRequestConfig}
): UseInfiniteQueryOptions<Awaited<ReturnType<typeof getConnect>>, TError, TData> & { queryKey: QueryKey } => {
const {query: queryOptions, axios: axiosOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetConnectQueryKey();

  
  
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getConnect>>> = ({ signal }) => getConnect({ signal, ...axiosOptions });
    
      
      
   return  { queryKey, queryFn,   staleTime: 10000,  ...queryOptions}}

export type GetConnectInfiniteQueryResult = NonNullable<Awaited<ReturnType<typeof getConnect>>>
export type GetConnectInfiniteQueryError = AxiosError<void | Error>

/**
 * @summary Login with a provider
 */
export const useGetConnectInfinite = <TData = Awaited<ReturnType<typeof getConnect>>, TError = AxiosError<void | Error>>(
  options?: { query?:UseInfiniteQueryOptions<Awaited<ReturnType<typeof getConnect>>, TError, TData>, axios?: AxiosRequestConfig}

  ):  UseInfiniteQueryResult<TData, TError> & { queryKey: QueryKey } => {

  const queryOptions = getGetConnectInfiniteQueryOptions(options)
...
export const getGetConnectQueryOptions = <TData = Awaited<ReturnType<typeof getConnect>>, TError = AxiosError<void | Error>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getConnect>>, TError, TData>, axios?: AxiosRequestConfig}
): UseQueryOptions<Awaited<ReturnType<typeof getConnect>>, TError, TData> & { queryKey: QueryKey } => {
const {query: queryOptions, axios: axiosOptions} = options ?? {};
...
export type GetConnectQueryResult = NonNullable<Awaited<ReturnType<typeof getConnect>>>
export type GetConnectQueryError = AxiosError<void | Error>

/**
 * @summary Login with a provider
 */
export const useGetConnect = <TData = Awaited<ReturnType<typeof getConnect>>, TError = AxiosError<void | Error>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getConnect>>, TError, TData>, axios?: AxiosRequestConfig}

  ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } => {

  const queryOptions = getGetConnectQueryOptions(options)
...
export const getGetAuthProviderCallbackInfiniteQueryOptions = <TData = Awaited<ReturnType<typeof getAuthProviderCallback>>, TError = AxiosError<Error>>(provider: string, options?: { query?:UseInfiniteQueryOptions<Awaited<ReturnType<typeof getAuthProviderCallback>>, TError, TData>, axios?: AxiosRequestConfig}
): UseInfiniteQueryOptions<Awaited<ReturnType<typeof getAuthProviderCallback>>, TError, TData> & { queryKey: QueryKey } => {
const {query: queryOptions, axios: axiosOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAuthProviderCallbackQueryKey(provider);
   ...
   return  { queryKey, queryFn, enabled: !!(provider),  staleTime: 10000,  ...queryOptions}}

export type GetAuthProviderCallbackInfiniteQueryResult = NonNullable<Awaited<ReturnType<typeof getAuthProviderCallback>>>
export type GetAuthProviderCallbackInfiniteQueryError = AxiosError<Error>

/**
 * @summary Default Callback from provider auth
 */
export const useGetAuthProviderCallbackInfinite = <TData = Awaited<ReturnType<typeof getAuthProviderCallback>>, TError = AxiosError<Error>>(
 provider: string, options?: { query?:UseInfiniteQueryOptions<Awaited<ReturnType<typeof getAuthProviderCallback>>, TError, TData>, axios?: AxiosRequestConfig}

  ):  UseInfiniteQueryResult<TData, TError> & { queryKey: QueryKey } => {

  const queryOptions = getGetAuthProviderCallbackInfiniteQueryOptions(provider,options)
...
export const getGetAuthEmailConfirmationInfiniteQueryOptions = <TData = Awaited<ReturnType<typeof getAuthEmailConfirmation>>, TError = AxiosError<void | Error>>(params?: GetAuthEmailConfirmationParams, options?: { query?:UseInfiniteQueryOptions<Awaited<ReturnType<typeof getAuthEmailConfirmation>>, TError, TData>, axios?: AxiosRequestConfig}
): UseInfiniteQueryOptions<Awaited<ReturnType<typeof getAuthEmailConfirmation>>, TError, TData> & { queryKey: QueryKey } => {
const {query: queryOptions, axios: axiosOptions} = options ?? {};
...
export type GetAuthEmailConfirmationInfiniteQueryResult = NonNullable<Awaited<ReturnType<typeof getAuthEmailConfirmation>>>
export type GetAuthEmailConfirmationInfiniteQueryError = AxiosError<void | Error>

/**
 * @summary Confirm user email
 */
export const useGetAuthEmailConfirmationInfinite = <TData = Awaited<ReturnType<typeof getAuthEmailConfirmation>>, TError = AxiosError<void | Error>>(
 params?: GetAuthEmailConfirmationParams, options?: { query?:UseInfiniteQueryOptions<Awaited<ReturnType<typeof getAuthEmailConfirmation>>, TError, TData>, axios?: AxiosRequestConfig}

  ):  UseInfiniteQueryResult<TData, TError> & { queryKey: QueryKey } => {

  const queryOptions = getGetAuthEmailConfirmationInfiniteQueryOptions(params,options)
